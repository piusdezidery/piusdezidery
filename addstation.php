...
$conn = mysqli_connect("localhost","root","","carrentaldb");
 ...
 if(isset($_POST['insert']))
 {
    ...
    $sql = " INSERT INTO `station`(`id`, `station`) VALUES ('$carno','$cname') ";
    // execute query
...
?>
  <div class="col-sm-7">
    ...
    <center><h1><b>REGSTRATED STATION</b></h1></center>
    <table class="table table-striep">
   
      <tr>
        <th>ID </th><th>STATION</th>
      </tr>
       <?php while($row=$se->fetch_array(MYSQLI_BOTH)) {
  
?>
      <tr>
        <td><?php   echo $row['id']; ?></td><td><?php   echo $row['station']; ?></td></td>
      </tr>
    <?php } ?>
