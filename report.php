...
$insert ="INSERT INTO `login`(`username`, `firstname`, `lastname`, `email`, `password`,`role`) VALUES ('$username','$firstname','$lastname','$email','$pass','$role')";
...
<div class="row">
  ...
  <div class="col-sm-4">
    <br>
        <center><h1><b>AGENT REGISTRATION</b></h1></center>
    <br>
<form action="report.php" method="post" >

  <label for="role">ROLE:</label>
  <input type="text" name="role" value="AGENT" readonly>
  <label for="fname">USER NAME:</label>
  <input type="text" id="carno" name="username">
  <label for="lname">FIRST NAME</label>
  <input type="text" id="cname" name="firstname">
  <label for="cost">LAST NAME</label>
  <input type="text" id="cost" name="lastname">
  <label for="cost">EMAIL</label>
  <input type="email" id="cost" name="email">
  <label for="cost">PASSWORD</label>
  <input type="password" id="cost" name="password">
  <label for="cost">CONFRIM PASSWORD</label>
  <input type="password" id="cost" name="password1">
...
?>
  <div class="col-sm-7">
    ...
    <center><h1><b>REGISTERED AGENT </b></h1></center>
    <table class="table table-striep">
   
      <tr>
        <th>USER NAME </th><th>FIRST NAME</th><th>LAST NAME</th><TH>EMAIL</TH>
      </tr>
       <?php while($row=$select->fetch_array(MYSQLI_BOTH)) {
  
?>
      <tr>
        <td><?php   echo $row['username']; ?></td><td><?php   echo $row['firstname']; ?></td><td>  <?php   echo $row['lastname']; ?> </td><td><?php   echo $row['email']; ?></td>
      </tr>
    <?php } ?>
