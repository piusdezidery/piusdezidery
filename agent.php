...
?>
  <div class="col-sm-12">
    ...
    <center><h1><b>   CONFIRMED ORDERS  </b></h1></center>
    <table class="table table-striep">
   
      <tr><th>SERIAL NO: </th>
  <th>PICK UP LOCATION </th><th>PICK UP DATE</th><th>RETURN LOACTION</th><TH>RETURN DATE</TH><TH>NAME OF PICKER</TH><TH>EMAIL</TH><TH>PHONE</TH><TH>NATIONAL ID</TH><TH>CAR NO</TH><TH>ACTION</TH><TH>TRANSACTION</TH>
      </tr>
...
?>
      <tr>
         <td><?php   echo $row['searial']; ?></td><td><?php   echo $row['pick']; ?></td><td><?php   echo $row['pdate']; ?></td><td> USA $ <?php   echo $row['rlocation']; ?> PER DAY</td><td><?php   echo $row['rdate']; ?></td><td><?php    echo $row['fname'];  // echo "<div id='img_div'>";
                    // echo "<img src='images/".$row['image']."' height='50' width='50' >";   ?></td><td><?php   echo $row['email']; ?><td><?php   echo $row['phone']; ?></td><td> <a href="resist.php?file_id=<?php echo $m['id'] ?> "> Download</a></td><td><?php   echo $row['carno']; ?></td><td> 

                       <button type="button" class="btn btn-primary">confirmed</button>  </td>
                      <td> <button type="button" class="btn btn-primary">View transaction</button></td>
      </tr>
    <?php } ?>
