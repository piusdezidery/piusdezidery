...
$day2 = $_SESSION['amount'];
 ...
 $conn = mysqli_connect("localhost","root","","carrentaldb");
  ...
  if(isset($_POST['insert']))
  {
    ...
    // Get text
    //$image_text = mysqli_real_escape_string($conn, $_POST['chat']);
    ...
    $target = "images/".basename($image);
     ...
     $insert = "INSERT INTO `buy`(`pick`, `pdate`, `rlocation`, `rdate`, `fname`, `email`, `phone`, `carno`,`id`,`searial`) VALUES ('$form','$date','$to','$dat','$fname','$email','$phone','$co','$image','$num')";
    ...
    echo "<script> location.href='resist.php' </script>";;
   // include('resist.php');
...
<form action="reg.php" method="post" enctype="multipart/form-data"  style=" background-color: #ffff;" >
 
        <center><h1><b>CUSTOMER FORM</b></h1></center>
    <br>

  <label for="fname">  </label>
  <input type="text" id="carno" name="fname" required placeholder="enter full name">
  <label for="lname"> </label>
  <input type="email" id="cname" name="email" required placeholder="enter email">
  <label for="cost"> </label><br><br>
  <input type="tel" id="cost" name="phone" required placeholder="enter phonenumber"> <br><br>

 
  
     <label for="car">ATTACH NATION ID</label>
